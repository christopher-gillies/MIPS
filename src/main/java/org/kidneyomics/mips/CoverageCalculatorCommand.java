...
@Component
public class CoverageCalculatorCommand implements RunCommand {
	...
	@Autowired
	public CoverageCalculatorCommand(ApplicationOptions applicationOptions, LoggerService loggerService) {
